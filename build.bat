...
clang++ gui\main.cpp gui\app_res.o core\config.cpp core\cursor.cpp core\scheduler.cpp core\utils.cpp -o curator_gui.exe -I deps -ladvapi32 -lcomctl32 -lole32 -luuid -municode -mwindows
